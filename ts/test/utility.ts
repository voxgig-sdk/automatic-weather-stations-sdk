...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.AUTOMATICWEATHERSTATIONS_TEST_LIVE ||
    'TRUE' === process.env.AUTOMATICWEATHERSTATIONS_TEST_OVERRIDE
  ) {
  ...
  m.AUTOMATICWEATHERSTATIONS_TEST_EXPLAIN = process.env.AUTOMATICWEATHERSTATIONS_TEST_EXPLAIN || m.AUTOMATICWEATHERSTATIONS_TEST_EXPLAIN
