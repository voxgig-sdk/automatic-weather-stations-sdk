...
const AutomaticWeatherStationsError_1 = require("./AutomaticWeatherStationsError");
...
class Context {
    ...
    error(code, msg) {
        return new AutomaticWeatherStationsError_1.AutomaticWeatherStationsError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
