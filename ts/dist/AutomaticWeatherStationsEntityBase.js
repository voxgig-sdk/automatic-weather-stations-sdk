...
exports.AutomaticWeatherStationsEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends AutomaticWeatherStationsEntityBase<Advice>`.
class AutomaticWeatherStationsEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.AutomaticWeatherStationsEntityBase = AutomaticWeatherStationsEntityBase;
//# sourceMappingURL=AutomaticWeatherStationsEntityBase.js.map