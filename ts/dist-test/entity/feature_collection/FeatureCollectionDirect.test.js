...
(0, node_test_1.describe)('FeatureCollectionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.AutomaticWeatherStationsSDK({
    ...
    (0, node_test_1.test)('direct-list-feature_collection', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-feature_collection', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.AUTOMATIC_WEATHER_STATIONS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.AutomaticWeatherStationsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['AUTOMATIC_WEATHER_STATIONS_TEST_FEATURE_COLLECTION_ENTID'];
    ...
    const client = new __1.AutomaticWeatherStationsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=FeatureCollectionDirect.test.js.map