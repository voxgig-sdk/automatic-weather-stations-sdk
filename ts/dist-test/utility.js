...
function envOverride(m) {
    if ('TRUE' === process.env.AUTOMATIC_WEATHER_STATIONS_TEST_LIVE ||
        'TRUE' === process.env.AUTOMATIC_WEATHER_STATIONS_TEST_OVERRIDE) {
    ...
    m.AUTOMATIC_WEATHER_STATIONS_TEST_EXPLAIN = process.env.AUTOMATIC_WEATHER_STATIONS_TEST_EXPLAIN || m.AUTOMATIC_WEATHER_STATIONS_TEST_EXPLAIN;
    return m;
}
