...
AQL-driven CLI and REPL for the AutomaticWeatherStations SDK. Positional arguments are
...
```sh
go build -o automatic-weather-stations-cli ./...
```
...
./automatic-weather-stations-cli load 1 collection
./automatic-weather-stations-cli load '{id:1}' collection
