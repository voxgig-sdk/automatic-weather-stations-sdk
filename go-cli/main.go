// Command AutomaticWeatherStations-cli is a CLI + REPL for the AutomaticWeatherStations SDK,
...
const prompt = "automatic-weather-stations"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "collection feature_collection item"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      AUTOMATIC_WEATHER_STATIONS_APIKEY (api key), AUTOMATIC_WEATHER_STATIONS_BASE (base url override)")
