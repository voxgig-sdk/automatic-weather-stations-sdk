...
func registerSDKWords(r *eng.Registry, client *sdk.AutomaticWeatherStationsSDK) {
...
func runOp(client *sdk.AutomaticWeatherStationsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
