...
// AutomaticWeatherStations SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AutomaticWeatherStationsSDK::test)
...
{
    private const SDK_CLASS = 'AutomaticWeatherStationsSDK';
    ...
    private const SDK_BASE = 'automaticweatherstations_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../automaticweatherstations_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
