...
class FeatureCollectionDirectTest extends TestCase
{
    public function test_direct_list_feature_collection(): void
    {
        $setup = feature_collection_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-feature_collection", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
