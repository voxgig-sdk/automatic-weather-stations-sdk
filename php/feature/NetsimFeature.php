...
// AutomaticWeatherStations SDK netsim feature
...
class AutomaticWeatherStationsNetsimFeature extends AutomaticWeatherStationsBaseFeature
{
    ...
    private function _simulate(AutomaticWeatherStationsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AutomaticWeatherStationsContext $ctx, array $applied): void
    {
        $client = $this->client;
