...
// AutomaticWeatherStations SDK debug feature
...
class AutomaticWeatherStationsDebugFeature extends AutomaticWeatherStationsBaseFeature
{
    ...
    private function _finish(AutomaticWeatherStationsContext $ctx, bool $ok): void
    {
