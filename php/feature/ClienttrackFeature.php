...
// AutomaticWeatherStations SDK clienttrack feature
...
class AutomaticWeatherStationsClienttrackFeature extends AutomaticWeatherStationsBaseFeature
{
    ...
    public function PostConstruct(AutomaticWeatherStationsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'AutomaticWeatherStations-SDK';
