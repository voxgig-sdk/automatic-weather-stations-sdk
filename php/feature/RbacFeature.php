...
// AutomaticWeatherStations SDK rbac feature
...
class AutomaticWeatherStationsRbacFeature extends AutomaticWeatherStationsBaseFeature
{
    ...
    private function _required(AutomaticWeatherStationsContext $ctx): ?string
    {
    ...
    private function _reject(AutomaticWeatherStationsContext $ctx, string $required): void
    {
    ...
    private function _track(AutomaticWeatherStationsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
