...
// AutomaticWeatherStations SDK metrics feature
...
class AutomaticWeatherStationsMetricsFeature extends AutomaticWeatherStationsBaseFeature
{
    ...
    private function _record(AutomaticWeatherStationsContext $ctx, bool $ok): void
    {
