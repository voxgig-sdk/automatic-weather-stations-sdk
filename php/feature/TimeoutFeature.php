...
// AutomaticWeatherStations SDK timeout feature
...
class AutomaticWeatherStationsTimeoutFeature extends AutomaticWeatherStationsBaseFeature
{
    ...
    private function _with_timeout(AutomaticWeatherStationsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AutomaticWeatherStationsContext $_ctx, float $ms): void
    {
        $client = $this->client;
