...
// AutomaticWeatherStations SDK utility: make_options

class AutomaticWeatherStationsMakeOptions
{
    ...
    public static function call(AutomaticWeatherStationsContext $ctx): array
    {
        ...
        //
        // `AutomaticWeatherStationsSchema::optspec()` is built from the model:
        ...
        $optspec = AutomaticWeatherStationsSchema::optspec();
