...
// AutomaticWeatherStations SDK utility: make_spec

require_once __DIR__ . '/Graphql.php';

require_once __DIR__ . '/../core/Spec.php';

class AutomaticWeatherStationsMakeSpec
{
    public static function call(AutomaticWeatherStationsContext $ctx): array
    {
        ...
        if ('graphql' === \Voxgig\Struct\Struct::getprop($point, 'kind')) {
            ...
            $ctx->spec->query = [];
            $ctx->spec->headers['content-type'] = AutomaticWeatherStationsGraphql::CONTENT_TYPE;
        } else {
