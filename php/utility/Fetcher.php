...
class AutomaticWeatherStationsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AutomaticWeatherStationsSDK/1.0)';
    ...
    public static function call(AutomaticWeatherStationsContext $ctx, string $fullurl, array $fetchdef): array
    {
