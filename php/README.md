...
The PHP SDK for the AutomaticWeatherStations API. Provides an entity-oriented interface using PHP conventions.
...
[$result, $err] = $client->AutomaticWeatherStations(null)->load(
    ["id" => "test01"], null
);
