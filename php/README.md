# AutomaticWeatherStations PHP SDK



The PHP SDK for the AutomaticWeatherStations API — an entity-oriented client using PHP conventions.
...
| `id` | `string` |  |
| `links` | `array` |  |
| `properties` | `array` | Weather station measurement properties |
| `type` | `string` |  |
...
The main class (`automaticweatherstations_sdk.php`) exports the SDK class
