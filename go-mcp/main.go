// Command AutomaticWeatherStations-mcp is an MCP server exposing the AutomaticWeatherStations
// SDK as MCP tools.
//
// Two tools are registered:
//
//	AutomaticWeatherStations_list  — list records of an entity
//	AutomaticWeatherStations_load  — load a single record of an entity
//
