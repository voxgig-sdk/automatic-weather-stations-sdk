...
|---|---|---|
| `ts/` | @voxgig-sdk/automatic-weather-stations-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/automatic-weather-stations-sdk \
      --repository voxgig-sdk/automatic-weather-stations-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/automatic-weather-stations-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/automatic-weather-stations-sdk --id=<id>` removes one.
