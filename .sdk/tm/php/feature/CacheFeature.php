...
// AutomaticWeatherStations SDK cache feature
...
class AutomaticWeatherStationsCacheFeature extends AutomaticWeatherStationsBaseFeature
{
    ...
    private function _through(AutomaticWeatherStationsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
