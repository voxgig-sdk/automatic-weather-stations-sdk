...
// AutomaticWeatherStations SDK streaming feature
...
class AutomaticWeatherStationsStreamingFeature extends AutomaticWeatherStationsBaseFeature
{
    ...
    private function _iterate(AutomaticWeatherStationsResult $result): \Generator
    {
    ...
    private function _streamable(AutomaticWeatherStationsContext $ctx): bool
    {
