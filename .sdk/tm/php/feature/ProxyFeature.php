...
// AutomaticWeatherStations SDK proxy feature
...
class AutomaticWeatherStationsProxyFeature extends AutomaticWeatherStationsBaseFeature
{
    ...
    public function init(AutomaticWeatherStationsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AutomaticWeatherStationsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
