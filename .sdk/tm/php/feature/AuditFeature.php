...
// AutomaticWeatherStations SDK audit feature
...
class AutomaticWeatherStationsAuditFeature extends AutomaticWeatherStationsBaseFeature
{
    ...
    private function _emit(AutomaticWeatherStationsContext $ctx, string $outcome): void
    {
