...
// AutomaticWeatherStations SDK ratelimit feature
...
class AutomaticWeatherStationsRatelimitFeature extends AutomaticWeatherStationsBaseFeature
{
    ...
    private function _acquire(AutomaticWeatherStationsContext $ctx): void
    {
    ...
    private function _track(AutomaticWeatherStationsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
