...
// AutomaticWeatherStations SDK utility: result_basic

class AutomaticWeatherStationsResultBasic
{
    public static function call(AutomaticWeatherStationsContext $ctx): ?AutomaticWeatherStationsResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof AutomaticWeatherStationsError) ? $result->err->msg : (string)$result->err;
