...
// AutomaticWeatherStations SDK utility: graphql
//
...
class AutomaticWeatherStationsGraphql
{
    ...
    // equivalent.
    public static function body(AutomaticWeatherStationsContext $ctx): mixed
    {
    ...
    public static function errors(AutomaticWeatherStationsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
