...
// AutomaticWeatherStations SDK pipeline test
//
...
{
    private static function utility(): AutomaticWeatherStationsUtility
    {
        return new AutomaticWeatherStationsUtility();
    }
    ...
    private static function ctx(array $over = []): AutomaticWeatherStationsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new AutomaticWeatherStationsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new AutomaticWeatherStationsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof AutomaticWeatherStationsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new AutomaticWeatherStationsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = AutomaticWeatherStationsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new AutomaticWeatherStationsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = AutomaticWeatherStationsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new AutomaticWeatherStationsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = AutomaticWeatherStationsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AutomaticWeatherStationsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = AutomaticWeatherStationsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new AutomaticWeatherStationsResponse([]),
            'result' => new AutomaticWeatherStationsResult([]),
        ]);
        [, $err] = AutomaticWeatherStationsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new AutomaticWeatherStationsSpec([]),
            'response' => null,
            'result' => new AutomaticWeatherStationsResult([]),
        ]);
        [, $err] = AutomaticWeatherStationsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new AutomaticWeatherStationsSpec(['step' => 's']),
            'response' => new AutomaticWeatherStationsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new AutomaticWeatherStationsResult([]),
        ]);
        [, $err] = AutomaticWeatherStationsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new AutomaticWeatherStationsSpec(['step' => 's']),
            'response' => new AutomaticWeatherStationsResponse(self::resp(200, ['v' => 1])),
            'result' => new AutomaticWeatherStationsResult([]),
        ]);
        [, $err] = AutomaticWeatherStationsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new AutomaticWeatherStationsSpec(['step' => 's']),
            'response' => new AutomaticWeatherStationsResponse(self::resp(200, ['v' => 2])),
            'result' => new AutomaticWeatherStationsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        AutomaticWeatherStationsMakeResponse::call($ctx);
    ...
    {
        $preset = new AutomaticWeatherStationsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new AutomaticWeatherStationsSpec([]),
            'response' => new AutomaticWeatherStationsResponse([]),
            'result' => new AutomaticWeatherStationsResult([]),
        ...
        [$got, $err] = AutomaticWeatherStationsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new AutomaticWeatherStationsResult([])]);
        [, $err] = AutomaticWeatherStationsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new AutomaticWeatherStationsSpec([]), 'result' => null]);
        [, $err] = AutomaticWeatherStationsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AutomaticWeatherStationsSpec(['step' => 's']),
            'result' => new AutomaticWeatherStationsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new AutomaticWeatherStationsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AutomaticWeatherStationsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AutomaticWeatherStationsSpec(['step' => 's']),
            'result' => new AutomaticWeatherStationsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new AutomaticWeatherStationsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AutomaticWeatherStationsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AutomaticWeatherStationsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new AutomaticWeatherStationsSpec([]),
            'result' => new AutomaticWeatherStationsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = AutomaticWeatherStationsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AutomaticWeatherStationsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new AutomaticWeatherStationsError('boom', 'boom');
        $utility->fetcher = function (AutomaticWeatherStationsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AutomaticWeatherStationsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = AutomaticWeatherStationsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (AutomaticWeatherStationsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = AutomaticWeatherStationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(AutomaticWeatherStationsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        AutomaticWeatherStationsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (AutomaticWeatherStationsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AutomaticWeatherStationsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = AutomaticWeatherStationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new AutomaticWeatherStationsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new AutomaticWeatherStationsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = AutomaticWeatherStationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = AutomaticWeatherStationsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = AutomaticWeatherStationsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new AutomaticWeatherStationsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, AutomaticWeatherStationsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new AutomaticWeatherStationsResult(['ok' => false])]);
        $this->expectException(AutomaticWeatherStationsError::class);
        AutomaticWeatherStationsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new AutomaticWeatherStationsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', AutomaticWeatherStationsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        AutomaticWeatherStationsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new AutomaticWeatherStationsBaseFeature();
        $b = new AutomaticWeatherStationsBaseFeature();
        AutomaticWeatherStationsFeatureAdd::call($ctx, $a);
        AutomaticWeatherStationsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): AutomaticWeatherStationsBaseFeature
    {
        $f = new AutomaticWeatherStationsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        AutomaticWeatherStationsFeatureAdd::call($ctx, self::named_feature('a'));
        AutomaticWeatherStationsFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        AutomaticWeatherStationsFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        AutomaticWeatherStationsFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        AutomaticWeatherStationsFeatureAdd::call($ctx, $replace);
        ...
        AutomaticWeatherStationsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?AutomaticWeatherStationsSpec $spec): AutomaticWeatherStationsContext
    {
    ...
    private static function auth_bags(): AutomaticWeatherStationsSpec
    {
        return new AutomaticWeatherStationsSpec(['headers' => [], 'query' => []]);
    }
    ...
    private static function auth_probe(array $options): ?array
    {
        ...
        AutomaticWeatherStationsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AutomaticWeatherStationsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new AutomaticWeatherStationsResponse(['headers' => null]),
            'result' => new AutomaticWeatherStationsResult([]),
        ]);
        AutomaticWeatherStationsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        AutomaticWeatherStationsResultBody::call($ctx);
