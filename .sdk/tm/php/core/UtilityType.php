...
// AutomaticWeatherStations SDK utility type

class AutomaticWeatherStationsUtility
{
    ...
    public static function copy(AutomaticWeatherStationsUtility $src): AutomaticWeatherStationsUtility
    {
        $u = new AutomaticWeatherStationsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
