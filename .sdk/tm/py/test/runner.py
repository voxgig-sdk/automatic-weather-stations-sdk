...
class AutomaticWeatherStationsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AutomaticWeatherStationsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = AutomaticWeatherStationsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = AutomaticWeatherStationsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
