...
class AutomaticWeatherStationsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AutomaticWeatherStationsTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = AutomaticWeatherStationsTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = AutomaticWeatherStationsTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
