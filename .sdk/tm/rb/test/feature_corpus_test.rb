# AutomaticWeatherStations SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # AutomaticWeatherStationsSDK.new, not AutomaticWeatherStationsSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    AutomaticWeatherStationsSDK.new(opts)
  end
