# AutomaticWeatherStations Python SDK

The Python SDK for the AutomaticWeatherStations API. Provides an entity-oriented interface following Pythonic conventions.
...
result, err = client.AutomaticWeatherStations(None).load(
    {"id": "test01"}, None
)
