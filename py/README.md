...
The Python SDK for the AutomaticWeatherStations API — an entity-oriented client following Pythonic conventions.
...
| `id` | `str` |  |
| `links` | `list` |  |
| `properties` | `dict` | Weather station measurement properties |
| `type` | `str` |  |
