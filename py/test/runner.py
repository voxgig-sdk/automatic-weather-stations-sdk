...
class AutomaticWeatherStationsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AutomaticWeatherStationsTestRunner.getenv("AUTOMATIC_WEATHER_STATIONS_TEST_LIVE")
        override = AutomaticWeatherStationsTestRunner.getenv("AUTOMATIC_WEATHER_STATIONS_TEST_OVERRIDE")
        ...
        explain = AutomaticWeatherStationsTestRunner.getenv("AUTOMATIC_WEATHER_STATIONS_TEST_EXPLAIN")
...
def entity_data(v):
    return AutomaticWeatherStationsTestRunner.entity_data(v)
...
def live_client_options():
    return AutomaticWeatherStationsTestRunner.live_client_options()
