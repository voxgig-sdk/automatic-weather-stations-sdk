# AutomaticWeatherStations SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AutomaticWeatherStationsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AutomaticWeatherStationsSDK(...) and AutomaticWeatherStationsSDK.test(...) become
#      AutomaticWeatherStationsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "automaticweatherstations_sdk"
_SDK_CLASS = "AutomaticWeatherStationsSDK"
