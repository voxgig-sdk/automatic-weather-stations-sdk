...
from automaticweatherstations_sdk.core.helpers import get_ctx_prop, to_map
...
class AutomaticWeatherStationsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = AutomaticWeatherStationsControl()
        ...
        if isinstance(sp, AutomaticWeatherStationsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, AutomaticWeatherStationsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, AutomaticWeatherStationsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return AutomaticWeatherStationsOperation({})
        ...
        op = AutomaticWeatherStationsOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return AutomaticWeatherStationsError(code, msg, self)
