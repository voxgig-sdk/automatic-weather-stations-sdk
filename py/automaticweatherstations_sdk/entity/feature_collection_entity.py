...
from automaticweatherstations_sdk.automaticweatherstations_types import (
    FeatureCollection,
...
class FeatureCollectionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FeatureCollectionEntity(self._client, opts)
    ...
    def data_get(self) -> FeatureCollection:
    ...
    def match_get(self) -> FeatureCollection:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[FeatureCollection]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.FeatureCollection().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
