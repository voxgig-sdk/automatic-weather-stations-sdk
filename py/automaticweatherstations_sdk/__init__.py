...
from automaticweatherstations_sdk.utility import register

# Load features
from automaticweatherstations_sdk.feature.base_feature import AutomaticWeatherStationsBaseFeature
from automaticweatherstations_sdk.features import _has_feature, _make_feature
...
class AutomaticWeatherStationsSDK:
    ...
    def get_utility(self):
        return AutomaticWeatherStationsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AutomaticWeatherStationsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Collection(self, data=None) -> "CollectionEntity":
        ...
        from automaticweatherstations_sdk.entity.collection_entity import CollectionEntity
    ...
    def FeatureCollection(self, data=None) -> "FeatureCollectionEntity":
        ...
        from automaticweatherstations_sdk.entity.feature_collection_entity import FeatureCollectionEntity
    ...
    def Item(self, data=None) -> "ItemEntity":
        ...
        from automaticweatherstations_sdk.entity.item_entity import ItemEntity
        return ItemEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "AutomaticWeatherStationsSDK":
        if sdkopts is None:
            sdkopts = {}
