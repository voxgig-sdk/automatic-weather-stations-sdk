# AutomaticWeatherStations Lua SDK Reference

Complete API reference for the AutomaticWeatherStations Lua SDK.
...
```lua
local results, err = client:FeatureCollection(nil):list(nil, nil)
```
