...
describe("FeatureCollectionDirect", function()
  it("should direct-list-feature_collection", function()
    local setup = feature_collection_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-feature_collection", setup.live and "live" or "unit")
...
function feature_collection_direct_setup(mockres)
