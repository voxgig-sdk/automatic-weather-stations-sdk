...
local SDK_MODULE = "automatic-weather-stations_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["collection"] = { ["test01"] = { id = "test01" } }, ["feature_collection"] = { ["test01"] = { id = "test01" } }, ["item"] = { ["test01"] = { id = "test01" } } } }'
