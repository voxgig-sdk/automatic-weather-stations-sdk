...
function runner.env_override(m)
  local live = runner.getenv("AUTOMATICWEATHERSTATIONS_TEST_LIVE")
  local override = runner.getenv("AUTOMATICWEATHERSTATIONS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("AUTOMATICWEATHERSTATIONS_TEST_EXPLAIN")
