...
function runner.env_override(m)
  local live = runner.getenv("AUTOMATIC_WEATHER_STATIONS_TEST_LIVE")
  local override = runner.getenv("AUTOMATIC_WEATHER_STATIONS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("AUTOMATIC_WEATHER_STATIONS_TEST_EXPLAIN")
