...
local FeatureCollectionEntity = {}
FeatureCollectionEntity.__index = FeatureCollectionEntity


function FeatureCollectionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FeatureCollectionEntity)
  self._name = "feature_collection"
  self._client = client
...
function FeatureCollectionEntity:get_name()
  return self._name
end


function FeatureCollectionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FeatureCollectionEntity.new(self._client, opts)
end
...
function FeatureCollectionEntity:mark_deleted()
  self._deleted = true
end


function FeatureCollectionEntity:deleted()
  return true == self._deleted
end


function FeatureCollectionEntity:data_set(args)
  if args ~= nil then
...
function FeatureCollectionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FeatureCollectionEntity:match_set(args)
  if args ~= nil then
...
function FeatureCollectionEntity:match_get()
...
function FeatureCollectionEntity:stream(action, args, callopts)
...
---@param reqmatch FeatureCollectionListMatch
---@param ctrl? table
---@return FeatureCollection[]
---@return string? err
function FeatureCollectionEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function FeatureCollectionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return FeatureCollectionEntity
