# AutomaticWeatherStations Lua SDK



The Lua SDK for the AutomaticWeatherStations API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/automatic-weather-stations-sdk/releases)),
...
Create an instance: `local feature_collection = client:FeatureCollection(nil)`
...
```lua
local feature_collections, err = client:FeatureCollection():list()
```
...
| `id` | `string` |  |
| `links` | `table` |  |
| `properties` | `table` | Weather station measurement properties |
| `type` | `string` |  |
...
The main module (`automatic-weather-stations_sdk`) exports the SDK constructor
