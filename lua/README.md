...
The Lua SDK for the AutomaticWeatherStations API. Provides an entity-oriented interface using Lua conventions.
...
local result, err = client:AutomaticWeatherStations(nil):load(
  { id = "test01" }, nil
)
