...
The Ruby SDK for the AutomaticWeatherStations API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.AutomaticWeatherStations(nil).load(
  { "id" => "test01" }, nil
)
