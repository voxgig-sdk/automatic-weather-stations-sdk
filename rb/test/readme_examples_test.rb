...
#      offline in seeded test mode (AutomaticWeatherStationsSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "AutomaticWeatherStations_sdk.rb")
  SDK_CLASS = "AutomaticWeatherStationsSDK"
  ...
  SDK_BASE = "AutomaticWeatherStations_sdk"
