# AutomaticWeatherStations SDK Item entity
...
class ItemEntity
  ...
  # @return [Item, Hash] the loaded Item; raises AutomaticWeatherStationsError on failure
    ...
    _run_op(ctx) do
      if ctx.result
        ...
        if ctx.result.resdata
          @_data = AutomaticWeatherStationsHelpers.to_map(VoxgigStruct.clone(ctx.result.resdata)) || {}
        end
      end
    end
  end
