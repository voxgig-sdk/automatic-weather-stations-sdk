# AutomaticWeatherStations SDK Collection entity
...
class CollectionEntity
  ...
  # @return [Array<Collection>, Array] the matching Collection items; raises AutomaticWeatherStationsError on failure
