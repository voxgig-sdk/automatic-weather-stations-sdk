...
func collectionBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("AUTOMATIC_WEATHER_STATIONS_TEST_COLLECTION_ENTID")
	...
	idmapResolved := core.ToMapAny(env["AUTOMATIC_WEATHER_STATIONS_TEST_COLLECTION_ENTID"])
