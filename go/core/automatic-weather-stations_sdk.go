...
type AutomaticWeatherStationsSDK struct {
	Mode     string
...
func NewAutomaticWeatherStationsSDK(options map[string]any) *AutomaticWeatherStationsSDK {
	sdk := &AutomaticWeatherStationsSDK{
		Mode:     "live",
		Features: []Feature{},
	}
...
func (sdk *AutomaticWeatherStationsSDK) OptionsMap() map[string]any {
...
func (sdk *AutomaticWeatherStationsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *AutomaticWeatherStationsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *AutomaticWeatherStationsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AutomaticWeatherStationsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *AutomaticWeatherStationsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *AutomaticWeatherStationsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("AutomaticWeatherStationsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *AutomaticWeatherStationsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AutomaticWeatherStationsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("AutomaticWeatherStationsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *AutomaticWeatherStationsSDK {
	...
	sdk := NewAutomaticWeatherStationsSDK(sdkopts)
	sdk.Mode = "test"
