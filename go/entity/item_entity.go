...
func NewItemEntity(client *core.AutomaticWeatherStationsSDK, entopts map[string]any) *ItemEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ItemEntity) List(_ map[string]any, _ map[string]any) (any, error) {
