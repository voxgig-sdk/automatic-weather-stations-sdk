...
type FeatureCollectionEntity struct {
	name    string
	client  *core.AutomaticWeatherStationsSDK
...
func NewFeatureCollectionEntity(client *core.AutomaticWeatherStationsSDK, entopts map[string]any) *FeatureCollectionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FeatureCollectionEntity) GetName() string { return e.name }
...
func (e *FeatureCollectionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FeatureCollectionEntity) Deleted() bool {
	return e.deleted
}


func (e *FeatureCollectionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFeatureCollectionEntity(e.client, opts)
}

func (e *FeatureCollectionEntity) Data(args ...any) any {
...
func (e *FeatureCollectionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an FeatureCollection; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FeatureCollectionEntity) DataTyped(data ...FeatureCollection) FeatureCollection {
	if len(data) > 0 {
		return typedFrom[FeatureCollection](e.Data(asMap(data[0])))
	}
	return typedFrom[FeatureCollection](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through FeatureCollection (all fields
// optional at the wire level).
func (e *FeatureCollectionEntity) MatchTyped(match ...FeatureCollection) FeatureCollection {
	if len(match) > 0 {
		return typedFrom[FeatureCollection](e.Match(asMap(match[0])))
	}
	return typedFrom[FeatureCollection](e.Match())
}
...
func (e *FeatureCollectionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FeatureCollectionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *FeatureCollectionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FeatureCollectionListMatch and returns []FeatureCollection. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FeatureCollectionEntity) ListTyped(reqmatch FeatureCollectionListMatch, ctrl map[string]any) ([]FeatureCollection, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[FeatureCollection](res), nil
}



func (e *FeatureCollectionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FeatureCollectionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FeatureCollectionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FeatureCollectionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
